module Parameter_Vars
  ! The Parameter_Vars module stores parameters used in the Af-Range model, and constants that are needed.  Modified May 17, 2023

  ! Constants
  integer, parameter  :: MAX_X_DIM=728, MAX_Y_DIM=810               !
  integer, parameter  :: MAX_RANGE_CELLS=600000                     !
  character(13)       :: INI_FILE='\Af_Range.ini'                   ! The one-line init file in the program directory, pointing to the application directory.
  ...
  character(17)       :: OUT_MAP_NAME= '\Output\Area.gof'           ! The globe, storing 0s and 1s showing land and ocean
  ...
  integer, parameter  :: WHOLE_MAP_COUNT=136                        ! Number of potential output variables ... UPDATE AS NEEDED
  ...
  integer, parameter  :: MAX_HERBIVORES=10                          ! The maximum number of herbivore species
  integer, parameter  :: BIO_POOLS=8                                ! The number of different biomass pools herbivores may eat from
  ! Pathways
  ...
  integer             :: x_dim, y_dim                               ! Actual maximum X and Y dimensions of the area
  real                :: lower_x, lower_y, upper_x, upper_y         ! Lower and upper dimensions of the world
  ...
  logical             :: rangeland_classes(255)                     ! Rangeland classes. Dimension large, with many classes, some of which may be empty.
  integer             :: herbivores                                 ! Number of actual herbivores in simulation
  ! Temporary global variables here to prevent extra entire surfaces from being stored
  real                :: tgreen_herb_biomass                         ! Temporary variables that store biomass that will be decremented until animals are fed
